...
* @description: en-GB (English - Great Britain) language for component User
...
$_lang['REGISTERDESC'] = 'Fill-in the form below to register. Your personal details will stay private.';
...
$_lang['UNAMETAKEN'] = "Username %s is already taken. Please select another one.";
$_lang['EMAILTAKEN'] = "E-mail %s is already in use by an other user. Please select another one.";
...
$_lang['MAILACTLINK'] = 'A message containing an activation link was sent to your e-mail address. 
...
$_lang['CLICKACTIVATE'] = 'Please click the link below to activate your account.';
...
$_lang['PASSRECOVDESC'] = 'Fill-in your username and your e-mail address. If the information you provide is correct 
...
$_lang['CRPASSACCFORG'] = 'Create a new password for your account if you have forgotten the current one.';
$_lang['LOGINOWNACC'] = 'Log in to the web site if you already own a user account.';
$_lang['TIMEZONE'] = 'Time zone';
$_lang['CHATIMELOCAL'] = 'Change the displayed time to your local time.';
$_lang['SETPREFLANG'] = 'Set your preferred language.';
...
$_lang['CHMAILADMACT'] = 'If you change the e-mail your account will be blocked until a site administrator re-activates it.';
...
$_lang['CNOT_ACTION_SELF'] = 'You cannot perform this action on your own account!';
$_lang['CNOT_ACTION_USER'] = 'You cannot perform this action on that user!';
$_lang['SURE_DEL_USER'] = 'Are you sure? The user as well as all of his comments and articles will be deleted.';
...
$_lang['CNOT_DEL_GROUP'] = 'You cannot delete this group!';
$_lang['CNOT_MOD_GROUP'] = 'You cannot modify this group!';
$_lang['CNOT_DEL_GROUP_MEMBERS'] = 'You cannot delete a group with members!';
...
$_lang['ACLVALUE_HELP'] = 'By default access is declined. So, normally, it has no sence to set value to 0. Select 1 to provide access. Use other values for special cases.';
