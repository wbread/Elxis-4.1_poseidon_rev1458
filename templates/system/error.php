<?php 
/**
* @version		$Id: error.php 1434 2013-05-05 17:06:35Z datahell $
* @package		Elxis
...
<body>
	<div class="exit_wrapper">
		<div id="exit_content">
			...
			<p class="msg"><?php echo $eLang->get('UNREC_ERROR_REQUEST'); ?></p>

<?php if (trim($page->message) != '') { ?>
			<div class="msgdetails" id="detailsmsg">
				<h4><?php echo $eLang->get('ERROR_DETAILS'); ?></h4>
				<?php echo $page->message; ?>
			</div>
<?php } ?>
			<div class="refcode"><?php echo $eLang->get('REFERENCE_CODE').': <span>'.$page->refcode.'</span>'; ?></div>
			<p class="msg" id="detailsmsg2"><?php echo $eLang->get('SORRY_INCONVENIENCE'); ?></p>
